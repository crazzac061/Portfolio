            ...
            <div className="max-w-7xl mx-auto w-full">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col justify-center space-y-6">
                        <div>
                            <h3 className="text-lg md:text-xl text-gray-400 mb-2">Learner</h3>
                            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-4">Student</h1>
                            <p className="text-gray-400 max-w-md">
                                Student with a vision for by curiosity, ambition, and a commitment to personal and academic growth.
                            </p>
                        </div>
                ...
                <div className="mt-20 flex flex-col md:flex-row items-center justify-between border-t border-gray-700 pt-12">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="mailto:beanie.0412@example.com" className="text-gray-400 hover:text-white transition-colors">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
